...
--%>
    ...
    <head>
        <title><spring:message code="etiq.editPresentationIdea"/></title>
        <script>
...
//        }
    ...
    <body>
        <div class="container">
            <h1 class="text-center"><spring:message code="etiq.editPresentationIdea"/></h1>
            ...
            <form:form id="formStudents" method ="post" action="savelessonidea.htm" >
                ...
                <fieldset>
                    <legend id="showPropiertys">
                        ...
                        <span onclick="setTimeout(function () {
                                $('#NameLessons').focus();
                            }, 300);" class="col-xs-12 text-right glyphicon glyphicon-triangle-bottom">
                        </span>
                    </legend>
                    <div class="form-group collapse" id="contenedorPropiertys" >
                        <div class="col-xs-6 center-block">
                            <label class="control-label"><spring:message code="etiq.namePresentation"/></label> <span class="glyphicon glyphicon-exclamation-sign" style="color:red"></span>
                        ...
                        <div class="col-xs-6 center-block form-group">
                            <label class="control-label"><spring:message code="etiq.presDesc"/></label> <span class="glyphicon glyphicon-exclamation-sign" style="color:red"></span>
                ...
                <fieldset>
                    ...
                    <div class="form-group collapse" id="contenedorDetails">
                        ...
                        <div class="col-xs-3 center-block form-group">
                            <label class="control-label"><spring:message code='etiq.Objective'/></label> <span class="glyphicon glyphicon-exclamation-sign" style="color:red"></span>
                ...
                <div class="col-xs-12 text-center">
                    <input type="submit" class="btn btn-success" id="createOnClick" value="<spring:message code="etiq.save"/>">
                </div>
            </form:form>
