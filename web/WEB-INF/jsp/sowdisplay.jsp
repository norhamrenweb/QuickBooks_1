...
//            formattree();
                        ...
                        to = setTimeout(function () {
                            ...
                            $("#tree>ul>li a>i").removeClass();
                            $("#tree>ul>li ul>li a>i").addClass("glyphicon glyphicon-book"); // para subjects
                            $("#tree>ul>li ul>li ul>li a>i").removeClass();
                            $("#tree>ul>li ul>li ul>li a>i").addClass("glyphicon glyphicon-screenshot");
                            $("#tree>ul>li ul>li ul>li  ul>li a>i").removeClass();
                            $("#tree>ul>li ul>li ul>li  ul>li a>i").addClass("glyphicon glyphicon-pushpin");
