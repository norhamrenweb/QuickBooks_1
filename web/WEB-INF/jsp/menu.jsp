    ...
    <div id="barralateral">
        <nav>
            ...
            <div class="col-xs-12 iconosmenulateral"><a href="<c:url value="/createlesson/startIdea.htm"/>"><div class="center-block"><input type="image" src="<c:url value="/recursos/img/iconos/LessonsIdea.svg"/>" data-toggle="tooltip" data-placement="top" title="Lessons Idea"></div></a></div>
