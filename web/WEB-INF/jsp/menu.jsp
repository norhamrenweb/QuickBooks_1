...
<!--            <div class="col-xs-12 iconosmenulateral"><a href="lessonList.htm?accion=loadLessons"><div class="center-block"><input type="image" src="<c:url value="/recursos/img/iconos/Calendar-01.svg"/>" data-toggle="tooltip" data-placement="top" title="View calendar"></div></a></div>-->
            ...
            <div class="col-xs-12 iconosmenulateral"><a href="<c:url value="/createlesson/start.htm"/>" ><div class="center-block"><input type="image" src="<c:url value="/recursos/img/iconos/classroomDashboard-01.svg"/>" data-toggle="tooltip" data-placement="top" title="Create new presnetation"></div></a></div>
            ...
            <div class="col-xs-12 iconosmenulateral"><a href="<c:url value="/createsetting/start.htm"/>" ><div class="center-block"><input type="image" src="<c:url value="/recursos/img/iconos/CreateSettings-01.svg"/>" data-toggle="tooltip" data-placement="top" title="Modify Settings"></div></a></div>
