...
public class PaymenttoCharge {
    ...
    public List<String> getAppliedtoRefID(int paymentId) throws SQLException, ClassNotFoundException
  ...
  public List<String> getAppliedtoAmount(int paymentId) throws SQLException, ClassNotFoundException
